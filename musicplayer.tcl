...
foreach img {
        ...
        {{[file join C:/ Users Ayush Desktop musicplayergui icons add.png]} {user image} user {}}
        {{[file join C:/ Users Ayush Desktop musicplayergui icons broken-heart.png]} {user image} user {}}
        {{[file join C:/ Users Ayush Desktop musicplayergui icons delete.png]} {user image} user {}}
        {{[file join C:/ Users Ayush Desktop musicplayergui icons like.png]} {user image} user {}}
        {{[file join C:/ Users Ayush Desktop musicplayergui icons pause.png]} {user image} user {}}
        {{[file join C:/ Users Ayush Desktop musicplayergui icons play.png]} {user image} user {}}
        {{[file join C:/ Users Ayush Desktop musicplayergui icons previous.png]} {user image} user {}}
        {{[file join C:/ Users Ayush Desktop musicplayergui icons refresh.png]} {user image} user {}}
        {{[file join C:/ Users Ayush Desktop musicplayergui icons stop.png]} {user image} user {}}
        {{[file join C:/ Users Ayush Desktop musicplayergui icons vinylrecord.png]} {user image} user {}}
...
proc vTclWindow.top42 {base} {
    ...
    button $top.but61 \
        ...
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons pause.png]] \
        -pady 0 -text Button 
    ...
    button $top.but62 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons play.png]] \
        -pady 0 -text Button 
    ...
    button $top.but63 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons stop.png]] \
        -pady 0 -text Button 
    ...
    label $top.lab64 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons vinylrecord.png]] \
        -text Label 
    ...
    label $top.lab76 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons previous.png]] \
        -text Label 
    ...
    button $top.but97 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons add.png]] \
        -pady 0 -text Button 
    ...
    button $top.but98 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons delete.png]] \
        -pady 0 -text Button 
    ...
    button $top.but103 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons broken-heart.png]] \
        -pady 0 -text Button 
    ...
    button $top.but105 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons like.png]] \
        -pady 0 -text Button 
    ...
    button $top.but107 \
        ...
        -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black \
        -image [vTcl:image:get_image [file join C:/ Users Ayush Desktop musicplayergui icons refresh.png]] \
        -pady 0 -text Button 
